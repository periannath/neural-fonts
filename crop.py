...
def crop_image_frequency(src_dir, dst_dir):
    f = open("399-frequency.txt", "r")
    if not os.path.exists(dst_dir):
        os.makedirs(dst_dir)
    for page in range(1,4):
        img = Image.open( src_dir + "/" + str(page) +"-frequency.png").convert('L')
        ...
        print("Processed frequency page " + str(page))
