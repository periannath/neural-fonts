...
if __name__ == "__main__":
    ...
    pickle_examples(sorted(glob.glob(os.path.join(args.dir, "*.jpg")), key=lambda e: float(os.path.splitext(os.path.basename(e))[0].replace("_","").replace("train","").replace("val",""))), train_path=train_path, val_path=val_path,
